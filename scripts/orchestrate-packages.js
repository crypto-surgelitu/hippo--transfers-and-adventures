...
const packageImageMap = {
  '1-day-tsavo-east': {
    ...
    gallery: [
      'tsavo/tsavo-east-exploration.webp', 
      'tsavo/tsavo-game-drive.webp', 
      'tsavo/final-loop.webp'
    ]
  },
  '2-days-tsavo-east': {
    ...
    hero: 'tsavo/tsavo-red-elephants.webp',
    gallery: [
      'tsavo/sunset-game-drive.webp', 
      'tsavo/morning-safari.webp'
    ]
  },
  '3-days-tsavo-east-taita-hills': {
    ...
    gallery: [
      'tsavo/tsavo-game-drive.webp', 
      'taita-hills/taita-hills-sanctuary.webp',
      'tsavo/final-game-drive.webp'
    ]
  },
  '3-days-tsavo-east-amboseli': {
    ...
    gallery: [
      'tsavo/tsavo-game-drive.webp', 
      'amboseli/amboseli-landscape.webp',
      'amboseli/amboseli-sunrise.webp'
    ]
  },
  ...
  '5-days-tsavo-east-taita-hills': {
    ...
    gallery: [
      'tsavo/tsavo-game-drive.webp', 
      'tsavo/tsavo-west-view.webp', 
      'amboseli/kilimanjaro-views.webp', 
      'taita-hills/taita-hills-sanctuary.webp', 
      'tsavo/final-loop.webp'
    ]
  },
  '6-days-safari-nairobi': {
    card: 'mara/mara-migration.webp',
    hero: 'mara/mara-migration.webp',
    gallery: [
      'mara/mara-migration.webp', 
      'naivasha/lake-naivasha.webp', 
      'naivasha/lake-naivasha.webp', 
      'amboseli/amboseli-sunrise.webp'
    ]
  },
  ...
  '10-days-samburu-tsavo-east': {
    ...
    gallery: [
      'samburu/samburu-reserve.webp',
      'samburu/ol-pejeta.webp',
      'mara/mara-migration.webp',
      'naivasha/lake-naivasha.webp',
      'amboseli/kilimanjaro-views.webp',
      'tsavo/tsavo-red-elephants.webp'
    ]
  },
  'wasini-island': {
    card: 'wasini/marine-snorkeling.webp',
    hero: 'wasini/marine-snorkeling.webp',
    gallery: [
      'wasini/marine-snorkeling.webp',
      'excursions/swahili-feast.webp', 
      'excursions/shimoni-caves.webp'
    ]
  },
  'marafa-hells-kitchen': {
    ...
    gallery: [
      'excursions/marafa-canyon.webp',
      'sunsets/canyon-sunset.webp'
    ]
  },
  'sardegna-2-island': {
    ...
    gallery: [
      'excursions/dolphin-snorkeling.webp',
      'beaches/sandbank-relaxation.webp',
      'excursions/beach-bbq.webp'
    ]
  },
  'mida-creek': {
    ...
    gallery: [
      'mida-creek/canoe-exploration.webp', 
      'mida-creek/boardwalk-birds.webp'
    ]
  }
};
