  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        image: "/images/packages/6-days-safari-nairobi/lake-naivasha-boat-ride.webp"
      },
      {
        day: "5-6",
        ...
        icon: "bed",
        accommodation: "Amboseli Lodge",
        image: "/images/packages/6-days-safari-nairobi/amboseli-departure.webp"
      }
    ],
    inclusions: ['Professional Guide', '4x4 Safari Vehicle', 'Park Fees', 'All Meals', 'Lodging'],
    exclusions: ['Tips', 'Personal expenses']
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        icon: "compass",
        image: "/images/packages/10-days-samburu-tsavo-east/tsavo-departure.webp"
      }
    ],
    inclusions: ['Professional Guide', '4x4 Safari Vehicle', 'Park Fees', 'All Meals', 'Lodging'],
    exclusions: ['Tips', 'Personal expenses']
